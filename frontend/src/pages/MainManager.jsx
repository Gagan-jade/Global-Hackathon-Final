    ...
    return (
        <div className="min-h-screen bg-black text-white p-8 relative flex flex-col items-center">
            ...
            <div className="relative z-10 w-full max-w-6xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {/* Employee Management Section */}
                    <div className="bg-gray-800 rounded-lg shadow-lg p-6 border border-blue-500 w-full">
                        <h2 className="text-2xl font-semibold text-blue-400 mb-4">
                            Employee Management
                        </h2>
                        <button
                            onClick={navigateToEmployeePage}
                            className="bg-blue-500 hover:bg-blue-600 text-black font-bold py-2 px-4 rounded transition duration-300 ease-in-out w-full"
                        >
                            View All Employees
                        </button>
                    </div>
                    ...
                    <div className="bg-gray-800 rounded-lg shadow-lg p-6 border border-blue-500 w-full">
                        ...
                        <button
                            onClick={handleAllocateProject}
                            className="bg-blue-500 hover:bg-blue-600 text-black font-bold py-2 px-4 rounded transition duration-300 ease-in-out w-full mb-4"
                        >
                            Allocate New Project
                        </button>
                    </div>
